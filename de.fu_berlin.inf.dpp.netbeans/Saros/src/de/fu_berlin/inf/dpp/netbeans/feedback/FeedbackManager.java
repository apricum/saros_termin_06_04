...
public class FeedbackManager extends AbstractFeedbackManager implements
    ...
    private static IPreferenceChangeListener preferenceChangeListener = new IPreferenceChangeListener() {
        ...
        public void preferenceChange(PreferenceChangeEvent event) {
            final String key = event.getPreferenceName();

            if (NetbeansPreferenceConstants.FEEDBACK_SURVEY_INTERVAL.equals(key)) {
                /*
            ...
            } else if (NetbeansPreferenceConstants.FEEDBACK_SURVEY_DISABLED.equals(key)) {
        ...
        try {
            ...
            if (preferences instanceof Preferences)
                ((Preferences) preferences)
                    .addPreferenceChangeListener((PreferenceChangeListener) preferenceChangeListener);
            else
    ...
    public int getSessionsUntilNext() {
        return FeedbackPreferences.getPreferences().getInt(
            NetbeansPreferenceConstants.SESSIONS_UNTIL_NEXT, -1);
    }
    ...
    public static void setSessionsUntilNext(int untilNext) {
        ...
        FeedbackPreferences.getPreferences().putInt(
            NetbeansPreferenceConstants.SESSIONS_UNTIL_NEXT, untilNext);
    }
    ...
    public static int getFeedbackStatus() {
        ...
        return FeedbackPreferences.getPreferences().getInt(
            NetbeansPreferenceConstants.FEEDBACK_SURVEY_DISABLED, -1);
    }
    ...
    public static void setFeedbackDisabled(final boolean disabled) {
        ...
        FeedbackPreferences.getPreferences().putInt(
            NetbeansPreferenceConstants.FEEDBACK_SURVEY_DISABLED, status);
    }
    ...
    public static int getSurveyInterval() {
        return FeedbackPreferences.getPreferences().getInt(
            NetbeansPreferenceConstants.FEEDBACK_SURVEY_INTERVAL, -1);
    }
    ...
    public static void setSurveyInterval(final int interval) {
        FeedbackPreferences.getPreferences().putInt(
            NetbeansPreferenceConstants.FEEDBACK_SURVEY_INTERVAL, interval);
    }
