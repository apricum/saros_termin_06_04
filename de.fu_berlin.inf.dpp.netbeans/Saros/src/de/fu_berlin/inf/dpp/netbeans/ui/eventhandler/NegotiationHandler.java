...
import de.fu_berlin.inf.dpp.netbeans.ui.wizards.pages.JoinSessionWizard;
...
public class NegotiationHandler implements INegotiationHandler {
    ...
    @Override
    public void handleIncomingProjectNegotiation(IncomingProjectNegotiation ipn) {
        ...
        protected IStatus run(IProgressMonitor monitor) {
            try {
                ...
                case REMOTE_CANCEL:
                    ...
                    return new Status(
                        IStatus.CANCEL,
                        ListenerForDocumentSwap.PLUGIN_ID,
                        MessageFormat
                            .format(
                                Messages.NegotiationHandler_canceled_invitation_text,
                                peer));
        ...
        protected IStatus run(IProgressMonitor monitor) {
            try {
                ...
                case REMOTE_CANCEL:
                    ...
                    return new Status(IStatus.CANCEL, ListenerForDocumentSwap.PLUGIN_ID, message);
                ...
                case REMOTE_ERROR:
                    ...
                    return new Status(IStatus.ERROR, ListenerForDocumentSwap.PLUGIN_ID, message);
                }
            } catch (Exception e) {
                LOG.error("This exception is not expected here: ", e);
                return new Status(IStatus.ERROR, ListenerForDocumentSwap.PLUGIN_ID,
