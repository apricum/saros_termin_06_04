 ...
 */
public class NetbeansPreferences extends Preferences{
    //public NetbeansPreferencesStoreAdapter store = new NetbeansPreferencesStoreAdapter();
    
    public NetbeansPreferences(NetbeansPreferenceStore store) {
       super(store);
       PreferenceInitializer.initialize(super.store);
    }
