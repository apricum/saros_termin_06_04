...
@OptionsPanelController.SubRegistration(
        ...
        keywordsCategory = "Advanced/Feedback")
@org.openide.util.NbBundle.Messages({"AdvancedOption_DisplayName_Feedback=Feedback", "AdvancedOption_Keywords_Feedback=saros feedback"})
public final class FeedbackOptionsPanelController extends OptionsPanelController {
    ...
    private FeedbackPanel getPanel() {
        if (panel == null) {
            panel = new FeedbackPanel(this);
        }
        return panel;
    }
