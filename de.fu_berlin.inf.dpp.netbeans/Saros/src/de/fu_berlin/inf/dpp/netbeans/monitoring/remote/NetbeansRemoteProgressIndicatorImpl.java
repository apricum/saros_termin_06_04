 ...
 * @author privateuser
 */
public class NetbeansRemoteProgressIndicatorImpl implements
    IRemoteProgressIndicator {

    private static final Logger LOG = Logger
        .getLogger(NetbeansRemoteProgressIndicatorImpl.class);
     ...
     */
    NetbeansRemoteProgressIndicatorImpl(final RemoteProgressManager rpm,
        ...
        final Job job = new Job(ModelFormatUtils.format(
            ...
            protected IStatus run(IProgressMonitor monitor) {
                try {
                    ...
                    rpm.progressIndicatorStopped(NetbeansRemoteProgressIndicatorImpl.this);
                }
            }
        };
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof NetbeansRemoteProgressIndicatorImpl))
            return false;

        return ObjectUtils.equals(remoteProgressID,
            ((NetbeansRemoteProgressIndicatorImpl) obj).remoteProgressID)
            && ObjectUtils.equals(remoteUser,
                ((NetbeansRemoteProgressIndicatorImpl) obj).remoteUser);
    }
}
